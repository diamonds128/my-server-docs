...
> 注意：此页面还未完善，有能力请在[GitHub](https://github.com/diamonds128/my-server-docs/edit/main/src/content/docs/start.md)补充更多信息，包括:安卓教程，此外还缺乏图片资源  
...
- **安装步骤**：
  ...
  2. 安装后启动，添加账户，如果你有正版账户，可登录微软账户，若没有，可以选择离线账户，注意ID **尽量为英文** ， **不包含特殊字符**
...
2. 点击进入安装界面，如果你没有安装模组的需要，则不需要安装除游戏本体以外的任何东西，实例名称建议英文不包含特殊字符，点击安装按钮开始
3. 等待安装完成
